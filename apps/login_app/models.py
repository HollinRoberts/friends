...
class Friend(models.Model):
    initiator = models.ForeignKey(User, related_name = "friended",null=True)
    reciever = models.ForeignKey(User, related_name = "friend_of",null=True)
    created_at = models.DateTimeField(auto_now_add=True,null=True)
    updated_at = models.DateTimeField(auto_now=True,null=True)
    def __repr__(self):
        return "<Friend object: {} {}>".format(self.initiator.name, self.reciever.name)
    objects = UserManager()
